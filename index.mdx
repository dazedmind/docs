...
For detailed version history, see the [Changelog](https://github.com/dazedmind/rlink/blob/main/CHANGELOG.md) in the repository.
...
<CardGroup cols={2}>
  ...
  <Card title="Live preview" icon="globe" href="https://rlink-dev.vercel.app">
